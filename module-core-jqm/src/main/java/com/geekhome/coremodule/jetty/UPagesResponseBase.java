...
import com.geekhome.common.utils.ByteArrayRocks;
...
public class UPagesResponseBase extends ResponseBase {
    ...
    public UPagesResponseBase(ILocalizationProvider resourceProvider, IUContentProvider uContentDispatchersSearcher) {
        setCacheable(true);
