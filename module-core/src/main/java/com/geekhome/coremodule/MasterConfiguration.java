...
public class MasterConfiguration extends Collector implements IMasterDependenciesChecker {
    ...
    CollectorCollection<Block> findBlocksByTarget(String targetId) {
    ...
    public void initialize(ArrayList<IModule> modules) throws Exception {
        ArrayList<DependenciesCheckerModule> dependenciesCheckerModules = new ArrayList<>();
        ArrayList<Collector> collectors = new ArrayList<>();
        ArrayList<IConfigurationValidator> configurationValidators = new ArrayList<>();

        for(IModule module : modules) {
            addToCollectionIfNotNull(module.createDependenciesCheckerModule(), dependenciesCheckerModules);
            addToCollectionIfNotNull(module.createCollector(), collectors);
            addToCollectionIfNotNull(module.createConfigurationValidator(), configurationValidators);
        }
        registerDependenciesCheckerModules(dependenciesCheckerModules);
