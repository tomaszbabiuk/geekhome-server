...
public class CoreModule extends Module {
    ...
    public Resource[] getResources() {
        return new Resource[]{
                ...
                new Resource("C:AnalogInputPorts", "Analog input ports", "Analogowe porty wejścia"),
                new Resource("C:AnalogOutputPorts", "Analog output ports", "Analogowe porty wyjścia"),
